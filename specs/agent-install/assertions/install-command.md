...
- Supported targets: `claude-code` (alias `claude`), `opencode`, `codex`:
...
- `spekk install` with a missing or unknown `--target` prints an error listing valid targets and exits 1.
